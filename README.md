  ...
  <tr>
    ...
    <td>
      ...
      <ul>
        ...
        <li><b>Semestre:</b> Octavo semestre</li>
        <li><b>Periodo:</b> Ene - Jun 2026</li>
      </ul>
    </td>
  </tr>
</table>
...
```text
PortafolioMoviles/
├── Evidencias/ (Evidencias generales de los 3 proyectos)
├── Proyecto_01_AnalisisDatosDart/
│   ├── Capturas/
│   ├── Codigo/
│   └── README.md
├── Proyecto_02_PalabrasAleatorias/
│   ├── Capturas/
│   ├── Codigo/
│   └── README.md
